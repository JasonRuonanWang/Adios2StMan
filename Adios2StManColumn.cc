...
namespace casacore {
    ...
    Adios2StManColumn::Adios2StManColumn (Adios2StMan* aParent, int aDataType, uInt aColNr)
    ...
    void Adios2StManColumn::setColumnName (String aName){
        itsColumnName = aName;
    }
    ...
    IPosition Adios2StManColumn::getShapeColumn (){
        return itsShape;
    }
    ...
    void Adios2StManColumn::getArrayMetaV (uint64_t rowStart, uint64_t nrRows, const Slicer& ns, void* data){
    }
    ...
    void Adios2StManColumn::getSliceV(uInt aRowNr, const Slicer& ns, void* dataPtr){
    ...
    void Adios2StManColumn::getArrayWrapper(uint64_t rowStart, uint64_t nrRows, const Slicer& ns, void* dataPtr){
        Bool deleteIt;
        void *data;
        switch (itsCasaDataType){
            case TpArrayBool:
