                                                 ...
                                                 const String &dataTypeId)
{
    ...
    case TpBool:
    case TpArrayBool:
        aColumn = new Adios2StManColumnT<unsigned char>(
            this, aDataType, ncolumn(), name, itsAdiosIO);
        break;
    case TpChar:
    case TpArrayChar:
        aColumn = new Adios2StManColumnT<char>(this, aDataType, ncolumn(), name,
                                               itsAdiosIO);
        break;
    case TpUChar:
    case TpArrayUChar:
    ...
    case TpShort:
    case TpArrayShort:
        aColumn = new Adios2StManColumnT<short>(this, aDataType, ncolumn(),
                                                name, itsAdiosIO);
        break;
    case TpUShort:
    case TpArrayUShort:
        aColumn = new Adios2StManColumnT<unsigned short>(
            this, aDataType, ncolumn(), name, itsAdiosIO);
        break;
    case TpInt:
    case TpArrayInt:
        aColumn = new Adios2StManColumnT<int>(this, aDataType, ncolumn(), name,
                                              itsAdiosIO);
        break;
    case TpUInt:
    case TpArrayUInt:
        aColumn = new Adios2StManColumnT<unsigned int>(
            this, aDataType, ncolumn(), name, itsAdiosIO);
        break;
    case TpFloat:
    case TpArrayFloat:
        aColumn = new Adios2StManColumnT<float>(this, aDataType, ncolumn(),
                                                name, itsAdiosIO);
        break;
    case TpDouble:
    case TpArrayDouble:
        aColumn = new Adios2StManColumnT<double>(this, aDataType, ncolumn(),
                                                 name, itsAdiosIO);
        break;
    case TpComplex:
    case TpArrayComplex:
        aColumn = new Adios2StManColumnT<Complex>(this, aDataType, ncolumn(),
                                                  name, itsAdiosIO);
        break;
    case TpDComplex:
    case TpArrayDComplex:
        aColumn = new Adios2StManColumnT<std::complex<double>>(
            this, aDataType, ncolumn(), name, itsAdiosIO);
        break;
    case TpString:
    case TpArrayString:
        aColumn = new Adios2StManColumnT<std::string>(
            this, aDataType, ncolumn(), name, itsAdiosIO);
        break;
    }
